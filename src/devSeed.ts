...
const SPECS: Spec[] = [
  { dayOffset: 7,  timeStart: '18:30', timeEnd: '20:30', venue: 0, sport: 'Badminton',    skillLevel: 'lower-intermediate', matchType: 'doubles', gender: 'open',   maxPlayers: 4,  fill: 1, hostNote: 'Casual intermediate doubles at Ethos. Booked Court 2 — shuttles on me, just bring a racket.' },
  ...
  { dayOffset: 12, timeStart: '11:00', timeEnd: '13:00', venue: 7, sport: 'Football',      skillLevel: 'lower-intermediate', matchType: 'doubles', gender: 'open',   maxPlayers: 10, fill: 5, hostNote: '5-a-side kickabout at Battersea. Mixed ability, just turn up for a run-around and some goals.' },
  { dayOffset: 13, timeStart: '20:00', timeEnd: '22:00', venue: 4, sport: 'Pickleball',    skillLevel: 'lower-intermediate', matchType: 'doubles', gender: 'open',   maxPlayers: 4,  fill: 2, hostNote: 'Pickleball doubles at Kensington. Rallies over score — friendly but competitive.' },
  ...
  { dayOffset: 21, timeStart: '10:00', timeEnd: '12:00', venue: 0, sport: 'Badminton',     skillLevel: 'lower-intermediate', matchType: 'doubles', gender: 'female', maxPlayers: 4,  fill: 2, hostNote: 'Weekend women\'s doubles at Ethos. Social, supportive, and a good sweat. Coffee after!' },
  { dayOffset: 23, timeStart: '18:00', timeEnd: '20:00', venue: 3, sport: 'Football',      skillLevel: 'lower-intermediate', matchType: 'doubles', gender: 'open',   maxPlayers: 8,  fill: 4, hostNote: '4-a-side at Westway astro. Mixed team, rolling subs, all welcome for a proper game.' },
